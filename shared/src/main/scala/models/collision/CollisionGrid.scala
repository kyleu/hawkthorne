...
object CollisionGrid {
  ...
  private[this] def decodeBase64Layer(o: JsonObject, width: Int, height: Int) = {
    ...
    nums.zipWithIndex.flatMap {
      ...
      case n => CollisionTile.fromInts(index = n._2, width = width, z = n._1)
    }.sortBy(t => t.y -> t.x)
  }
}

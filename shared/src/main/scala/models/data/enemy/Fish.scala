...
object Fish extends EnemyTemplate(
  ...
  sounds = Seq.empty,
  animations = Seq(
    Animation(id = "dying.right", frames = IndexedSeq(2), delay = 1.0, loop = false),
    Animation(id = "dying.left", frames = IndexedSeq(2), delay = 1.0, loop = false),
    Animation(id = "default.right", frames = IndexedSeq(0, 1), delay = 0.3, loop = true),
    Animation(id = "default.left", frames = IndexedSeq(0, 1), delay = 0.3, loop = true),
    Animation(id = "hurt.right", frames = IndexedSeq(0, 1), delay = 0.3, loop = true),
